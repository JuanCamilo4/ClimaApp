...
export interface SearchClimaResponse {
    coord:      Coord;
    weather:    Weather[];
    base:       string;
    main:       Main;
...
export class Convert {
    public static toSearchGifsResponse(json: string): SearchClimaResponse {
        return cast(JSON.parse(json), r("SearchGifsResponse"));
    }

    public static searchGifsResponseToJson(value: SearchClimaResponse): string {
